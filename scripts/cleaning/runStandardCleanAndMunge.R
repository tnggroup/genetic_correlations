...
#remotes::install_github("tnggroup/genetic_correlations",ref = 'main') #public repository
#remotes::install_github("tnggroup/genetic_correlations",ref = 'main', auth_token = "YOUR_PAT") #private repository example
