...
# if no Z column
if(any(colnames(cSumstats) == "Z") == 0){
  cSumstats$Z<-abs(qnorm(cSumstats$P/2)) #calculate Z value using qnorm function then divide by 2
  }
  
  cat("Z column inserted based on P value")
```


# Add missing effect standard errors column 
If missing, add standard errors from beta & z or OR & z 
...
# if no BETA column
if(any(colnames(cSumstats) == "BETA") == 0){
