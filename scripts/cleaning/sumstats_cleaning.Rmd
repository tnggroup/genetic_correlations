...
if(any(names(sumstats) == 'NEF')){
  ...
  if(any(names(sumstats) == 'N_CAS') & any(names(sumstats) == 'N_CON')){
...
# Changed to fwrite for compression as have had experience where gzfile truncates the output.
fwrite(cSumstats, paste0("../cleaned/", cCode, ".gz"), sep='\t', na='NA', quote=F)
